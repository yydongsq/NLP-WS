...
import org.jeecg.modules.demo.mynlp.common.ParticipleCommon;
...
public class HanLPParticipleController {
    ...
    public Result<String> hello(@RequestParam("type") String type) {
        ParticipleCommon participle = new ParticipleCommon();
        String text="中国和美国都有自己的发展目标111111。中国坚持改革开放，科学发展，力争成为一个富裕强大文明的国家，造福于中国人民和世界人民，同时坚持独立自主外交，维护世界和平。";
